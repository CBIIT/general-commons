...
export const facetsConfig = [
  ...
  },
  {
    ...
    apiPath: "filterSubjectCountByLibrarySourceMaterial",
    apiForFiltering: "filterSubjectCountByLibrarySourceMaterial",
    datafield: "library_source_materials",
    field: "group",
    type: InputTypes.CHECKBOX,
    sort_type: sortType.ALPHABET,
    show: true,
  },
  {
    ...
    apiPath: "filterSubjectCountByLibrarySourceMolecule",
    apiForFiltering: "filterSubjectCountByLibrarySourceMolecule",
    datafield: "library_source_molecules",
    field: "group",
    type: InputTypes.CHECKBOX,
    sort_type: sortType.ALPHABET,
    show: true,
