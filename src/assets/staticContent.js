...
export const STATIC_CONTENT = {
  ...
  cart: {
    README_MD: `${env.REACT_APP_STATIC_CONTENT_URL}cart/fileCentricCartPageREADME.md`,
    README_PDF: `${env.REACT_APP_STATIC_CONTENT_URL}cart/GC-SELECTED-FILES-CART-README.pdf`,
  },
