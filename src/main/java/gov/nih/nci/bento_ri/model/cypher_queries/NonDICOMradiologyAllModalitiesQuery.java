...
public class NonDICOMradiologyAllModalitiesQuery {
    public static final String NON_DICOM_RADIOLOGY_ALL_MODALITIES_QUERY = """
        MATCH (n:NonDICOMradiologyAllModalities)
        WHERE
            $non_dicom_radiology_all_modalities_ids = [] OR n.NonDICOMradiologyAllModalities_id IN $non_dicom_radiology_all_modalities_ids
        WITH n, n {.*} AS output
