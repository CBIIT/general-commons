          ...
          <div className={classes.contentRight}>
            <div className={classes.contentRightTop}>
              ...
              <div className={classes.studies}>
                ...
                <div className={classes.content}>
                  <a href="https://datacommons.cancer.gov/submit#2" className={classes.mailLink} target="_blank" rel="noopener noreferrer">
...
const styles = () => ({
  ...
  contentHeader: {
    ...
    fontWeight: '500',
    fontSize: '26px',
    lineHeight: '31.47px !important',
    letterSpacing: '0.02em',
    padding: '10px 0 6.91px',
  },
  contentContainer: {
    width: '234px',
    color: '#010101',
