...
import { XoomInOut } from '@bento-core/about';
                                  ...
                                  if (rowValue != null && ((/\[(.+)\]\((.+)\)/g.test(rowValue)) || (/\((.+)\)\[(.+)\]/g.test(rowValue)))) {
                                    ...
                                    outputHTML = (
                                      <td className={classes.tableCell}>
                                        ...
                                        {type ? '' : (
                                          <img
                                            src="https://raw.githubusercontent.com/CBIIT/bento-tools/master/src/components/assets/about/About-Table-ExternalLink.svg"
                                            alt="outbounnd web site icon"
