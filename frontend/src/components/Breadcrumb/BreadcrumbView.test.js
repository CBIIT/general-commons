...
describe("Breadcrumb Component", () => {
  describe("Rendering", () => {
    ...
    it("should render a single breadcrumb item as a link", () => {
      ...
      expect(link.closest("a")).toHaveAttribute("id", "1_breadcrumb");
    });
  ...
  describe("Link Navigation", () => {
    it("should render links with correct href attributes", () => {
      ...
      expect(homeLink).toHaveAttribute("id", "1_breadcrumb");
      expect(aboutLink).toHaveAttribute("id", "2_breadcrumb");
    });
  ...
  describe("Separators", () => {
    it("should render '>' separators between items", () => {
      ...
      const separatorCount = (container.textContent.match(/>/g) || []).length;
      expect(separatorCount).toBe(2);
    });

    it("should not render '>' after the last item", () => {
      const data = [
        { name: "Home", isALink: true, to: "/" },
    ...
    it("should not render any '>' separators for a single item", () => {
      const data = [{ name: "Home", isALink: false }];
      const { container } = renderWithRouter(<Breadcrumb data={data} />);
  ...
  describe("Styling", () => {
    it("should apply correct CSS classes to the container", () => {
      ...
      const breadcrumbContainer = container.querySelector("#bread_crumb");
      expect(breadcrumbContainer).toBeInTheDocument();
    });

    it("should render links as <a> and non-links as <span>", () => {
      const data = [
